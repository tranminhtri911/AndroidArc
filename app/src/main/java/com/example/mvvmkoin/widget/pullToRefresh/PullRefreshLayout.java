package com.example.mvvmkoin.widget.pullToRefresh;
...
public class PullRefreshLayout extends ViewGroup {
    ...
    public PullRefreshLayout(Context context, AttributeSet attrs) {
        ...
        final int type =
                a.getInteger(R.styleable.refresh_PullRefreshLayout_refreshType, STYLE_MATERIAL);
        final int colorsId =
                a.getResourceId(R.styleable.refresh_PullRefreshLayout_refreshColors, 0);
        ...
        if (colorsId > 0) {
            ...
            mColorSchemeColors = new int[] {
                    Color.rgb(0xC9, 0x34, 0x37), Color.rgb(0x37, 0x5B, 0xF1),
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //        mRefreshView.measure(MeasureSpec.makeMeasureSpec(mRefreshViewWidth, MeasureSpec
        // .EXACTLY), MeasureSpec.makeMeasureSpec(mRefreshViewHeight, MeasureSpec.EXACTLY));
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        mTarget.layout(left, top + mTarget.getTop(), left + width - right,
