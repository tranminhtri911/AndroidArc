...
class MaterialDrawable extends RefreshDrawable implements Animatable {
    ...
    private void setupAnimators() {
        ...
        final Animation animation = new Animation() {
            ...
            public void applyTransformation(float interpolatedTime, Transformation t) {
                ...
                final float endTrim =
                        startingEndTrim + (minArc * START_CURVE_INTERPOLATOR.getInterpolation(
                                interpolatedTime));
                ring.setEndTrim(endTrim);

                final float startTrim =
                        startingTrim + (MAX_PROGRESS_ARC * END_CURVE_INTERPOLATOR.getInterpolation(
                                interpolatedTime));
                ring.setStartTrim(startTrim);
                ...
                float groupRotation = ((720.0f / NUM_POINTS) * interpolatedTime) + (720.0f * (
                        mRotationCount
                                / NUM_POINTS));
    ...
    private class OvalShadow extends OvalShape {
        ...
        public OvalShadow(int shadowRadius, int circleDiameter) {
            ...
            mRadialGradient =
                    new RadialGradient(mCircleDiameter / 2, mCircleDiameter / 2, mShadowRadius,
                            new int[] {
        ...
        public void draw(Canvas canvas, Paint paint) {
            ...
            canvas.drawCircle(x, y, (mCircleDiameter / 2 + mShadowRadius), mShadowPaint);
