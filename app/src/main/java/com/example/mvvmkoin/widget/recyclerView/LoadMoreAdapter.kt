...
abstract class LoadMoreAdapter<T> : BaseRecyclerViewAdapter<T, RecyclerView.ViewHolder>() {
    ...
    companion object {
        ...
        class ItemLoadMoreVH(binding: ViewDataBinding) :
            BaseItemVH<Boolean, ItemLoadMoreViewModel>(binding) {

            override val createVM: ItemLoadMoreViewModel
                get() = ItemLoadMoreViewModel()
        }
    }
}